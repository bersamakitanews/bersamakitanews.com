...
var defaultConfig = {channel:'detikcom-breakingnews',successCallback:successHandler,errorCallback:errorHandler,requestWinPostMsg:true};bersamakitanewsLiveUserCounter.setConfig(defaultConfig);
